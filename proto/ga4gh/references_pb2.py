...
_REFERENCESET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reference_ids', full_name='ga4gh.ReferenceSet.reference_ids', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='md5checksum', full_name='ga4gh.ReferenceSet.md5checksum', index=3,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='ncbi_taxon_id', full_name='ga4gh.ReferenceSet.ncbi_taxon_id', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='description', full_name='ga4gh.ReferenceSet.description', index=5,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='assembly_id', full_name='ga4gh.ReferenceSet.assembly_id', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_uri', full_name='ga4gh.ReferenceSet.source_uri', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_accessions', full_name='ga4gh.ReferenceSet.source_accessions', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_derived', full_name='ga4gh.ReferenceSet.is_derived', index=9,

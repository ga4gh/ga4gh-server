...
_SEARCHVARIANTSETSRESPONSE.fields_by_name['variant_sets'].message_type = proto_dot_ga4gh_dot_variants__pb2._VARIANTSET
_SEARCHVARIANTSRESPONSE.fields_by_name['variants'].message_type = proto_dot_ga4gh_dot_variants__pb2._VARIANT
_SEARCHCALLSETSRESPONSE.fields_by_name['call_sets'].message_type = proto_dot_ga4gh_dot_variants__pb2._CALLSET
...
SearchVariantSetsRequest = _reflection.GeneratedProtocolMessageType('SearchVariantSetsRequest', (_message.Message,), dict(
  ...
  __module__ = 'proto.ga4gh.variant_service_pb2'

...
from proto.ga4gh import common_pb2 as proto_dot_ga4gh_dot_common__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='proto/ga4gh/reads.proto',
  package='ga4gh',
  syntax='proto3',
  serialized_pb=_b('\n\x17proto/ga4gh/reads.proto\x12\x05ga4gh\x1a\x18proto/ga4gh/common.proto\x1a\x1aproto/ga4gh/metadata.proto\x1a\"proto/google/protobuf/struct.proto\"Y\n\tReadStats\x12\x1a\n\x12\x61ligned_read_count\x18\x01 \x01(\x03\x12\x1c\n\x14unaligned_read_count\x18\x02 \x01(\x03\x12\x12\n\nbase_count\x18\x03 \x01(\x03\"\x88\x04\n\tReadGroup\x12\n\n\x02id\x18\x01 \x01(\t\x12\x12\n\ndataset_id\x18\x02 \x01(\t\x12\x0c\n\x04name\x18\x03 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x04 \x01(\t\x12\x11\n\tsample_id\x18\x05 \x01(\t\x12%\n\nexperiment\x18\x06 \x01(\x0b\x32\x11.ga4gh.Experiment\x12\x1d\n\x15predicted_insert_size\x18\x07 \x01(\x05\x12\x0f\n\x07\x63reated\x18\x08 \x01(\x03\x12\x0f\n\x07updated\x18\t \x01(\x03\x12\x1f\n\x05stats\x18\n \x01(\x0b\x32\x10.ga4gh.ReadStats\x12*\n\x08programs\x18\x0b \x03(\x0b\x32\x18.ga4gh.ReadGroup.Program\x12\x18\n\x10reference_set_id\x18\x0c \x01(\t\x12(\n\x04info\x18\r \x03(\x0b\x32\x1a.ga4gh.ReadGroup.InfoEntry\x1a\x63\n\x07Program\x12\x14\n\x0c\x63ommand_line\x18\x01 \x01(\t\x12\n\n\x02id\x18\x02 \x01(\t\x12\x0c\n\x04name\x18\x03 \x01(\t\x12\x17\n\x0fprev_program_id\x18\x04 \x01(\t\x12\x0f\n\x07version\x18\x05 \x01(\t\x1aG\n\tInfoEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12)\n\x05value\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.ListValue:\x02\x38\x01\"\x84\x01\n\x0cReadGroupSet\x12\n\n\x02id\x18\x01 \x01(\t\x12\x12\n\ndataset_id\x18\x02 \x01(\t\x12\x0c\n\x04name\x18\x03 \x01(\t\x12\x1f\n\x05stats\x18\x04 \x01(\x0b\x32\x10.ga4gh.ReadStats\x12%\n\x0bread_groups\x18\x05 \x03(\x0b\x32\x10.ga4gh.ReadGroup\"n\n\x0fLinearAlignment\x12!\n\x08position\x18\x01 \x01(\x0b\x32\x0f.ga4gh.Position\x12\x17\n\x0fmapping_quality\x18\x02 \x01(\x05\x12\x1f\n\x05\x63igar\x18\x03 \x03(\x0b\x32\x10.ga4gh.CigarUnit\"\x16\n\x08\x46ragment\x12\n\n\x02id\x18\x01 \x01(\t\"\xbe\x04\n\rReadAlignment\x12\n\n\x02id\x18\x01 \x01(\t\x12\x15\n\rread_group_id\x18\x02 \x01(\t\x12\x13\n\x0b\x66ragment_id\x18\x03 \x01(\t\x12\x15\n\rfragment_name\x18\x04 \x01(\t\x12\x18\n\x10proper_placement\x18\x05 \x01(\x08\x12\x1a\n\x12\x64uplicate_fragment\x18\x06 \x01(\x08\x12\x14\n\x0cnumber_reads\x18\x07 \x01(\x05\x12\x17\n\x0f\x66ragment_length\x18\x08 \x01(\x05\x12\x13\n\x0bread_number\x18\t \x01(\x05\x12$\n\x1c\x66\x61iled_vendor_quality_checks\x18\n \x01(\x08\x12)\n\talignment\x18\x0b \x01(\x0b\x32\x16.ga4gh.LinearAlignment\x12\x1b\n\x13secondary_alignment\x18\x0c \x01(\x08\x12\x1f\n\x17supplementary_alignment\x18\r \x01(\x08\x12\x18\n\x10\x61ligned_sequence\x18\x0e \x01(\t\x12\x17\n\x0f\x61ligned_quality\x18\x0f \x03(\x05\x12+\n\x12next_mate_position\x18\x10 \x01(\x0b\x32\x0f.ga4gh.Position\x12,\n\x04info\x18\x11 \x03(\x0b\x32\x1e.ga4gh.ReadAlignment.InfoEntry\x1aG\n\tInfoEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12)\n\x05value\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.ListValue:\x02\x38\x01\x62\x06proto3')
  ,
  dependencies=[proto_dot_ga4gh_dot_common__pb2.DESCRIPTOR,proto_dot_ga4gh_dot_metadata__pb2.DESCRIPTOR,proto_dot_google_dot_protobuf_dot_struct__pb2.DESCRIPTOR,])
...
_READGROUP_PROGRAM = _descriptor.Descriptor(
  name='Program',
  full_name='ga4gh.ReadGroup.Program',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='command_line', full_name='ga4gh.ReadGroup.Program.command_line', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='id', full_name='ga4gh.ReadGroup.Program.id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='ga4gh.ReadGroup.Program.name', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='prev_program_id', full_name='ga4gh.ReadGroup.Program.prev_program_id', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='version', full_name='ga4gh.ReadGroup.Program.version', index=4,
...
_READGROUP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sample_id', full_name='ga4gh.ReadGroup.sample_id', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='experiment', full_name='ga4gh.ReadGroup.experiment', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='predicted_insert_size', full_name='ga4gh.ReadGroup.predicted_insert_size', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='created', full_name='ga4gh.ReadGroup.created', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='updated', full_name='ga4gh.ReadGroup.updated', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stats', full_name='ga4gh.ReadGroup.stats', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='programs', full_name='ga4gh.ReadGroup.programs', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reference_set_id', full_name='ga4gh.ReadGroup.reference_set_id', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.ReadGroup.info', index=12,
  ...
  nested_types=[_READGROUP_PROGRAM, _READGROUP_INFOENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_FRAGMENT = _descriptor.Descriptor(
  name='Fragment',
  full_name='ga4gh.Fragment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='ga4gh.Fragment.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_READALIGNMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fragment_id', full_name='ga4gh.ReadAlignment.fragment_id', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='fragment_name', full_name='ga4gh.ReadAlignment.fragment_name', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='proper_placement', full_name='ga4gh.ReadAlignment.proper_placement', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='duplicate_fragment', full_name='ga4gh.ReadAlignment.duplicate_fragment', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='number_reads', full_name='ga4gh.ReadAlignment.number_reads', index=6,
      number=7, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='fragment_length', full_name='ga4gh.ReadAlignment.fragment_length', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='read_number', full_name='ga4gh.ReadAlignment.read_number', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='failed_vendor_quality_checks', full_name='ga4gh.ReadAlignment.failed_vendor_quality_checks', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alignment', full_name='ga4gh.ReadAlignment.alignment', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='secondary_alignment', full_name='ga4gh.ReadAlignment.secondary_alignment', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='supplementary_alignment', full_name='ga4gh.ReadAlignment.supplementary_alignment', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='aligned_sequence', full_name='ga4gh.ReadAlignment.aligned_sequence', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='aligned_quality', full_name='ga4gh.ReadAlignment.aligned_quality', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='next_mate_position', full_name='ga4gh.ReadAlignment.next_mate_position', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.ReadAlignment.info', index=16,
...
_READGROUP_INFOENTRY.fields_by_name['value'].message_type = proto_dot_google_dot_protobuf_dot_struct__pb2._LISTVALUE
_READGROUP_INFOENTRY.containing_type = _READGROUP
_READGROUP.fields_by_name['experiment'].message_type = proto_dot_ga4gh_dot_metadata__pb2._EXPERIMENT
...
_LINEARALIGNMENT.fields_by_name['position'].message_type = proto_dot_ga4gh_dot_common__pb2._POSITION
_LINEARALIGNMENT.fields_by_name['cigar'].message_type = proto_dot_ga4gh_dot_common__pb2._CIGARUNIT
_READALIGNMENT_INFOENTRY.fields_by_name['value'].message_type = proto_dot_google_dot_protobuf_dot_struct__pb2._LISTVALUE
...
_READALIGNMENT.fields_by_name['next_mate_position'].message_type = proto_dot_ga4gh_dot_common__pb2._POSITION
...
ReadStats = _reflection.GeneratedProtocolMessageType('ReadStats', (_message.Message,), dict(
  ...
  __module__ = 'proto.ga4gh.reads_pb2'
...
Fragment = _reflection.GeneratedProtocolMessageType('Fragment', (_message.Message,), dict(
  ...
  __module__ = 'proto.ga4gh.reads_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.Fragment)
  ))

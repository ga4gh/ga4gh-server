...
_VARIANTSETMETADATA_INFOENTRY.fields_by_name['value'].message_type = proto_dot_google_dot_protobuf_dot_struct__pb2._LISTVALUE
...
_CALLSET_INFOENTRY.fields_by_name['value'].message_type = proto_dot_google_dot_protobuf_dot_struct__pb2._LISTVALUE
_CALLSET_INFOENTRY.containing_type = _CALLSET
_CALLSET.fields_by_name['info'].message_type = _CALLSET_INFOENTRY
_CALL_INFOENTRY.fields_by_name['value'].message_type = proto_dot_google_dot_protobuf_dot_struct__pb2._LISTVALUE
_CALL_INFOENTRY.containing_type = _CALL
_CALL.fields_by_name['info'].message_type = _CALL_INFOENTRY
_VARIANT_INFOENTRY.fields_by_name['value'].message_type = proto_dot_google_dot_protobuf_dot_struct__pb2._LISTVALUE
...
VariantSetMetadata = _reflection.GeneratedProtocolMessageType('VariantSetMetadata', (_message.Message,), dict(
  ...
  InfoEntry = _reflection.GeneratedProtocolMessageType('InfoEntry', (_message.Message,), dict(
    ...
    __module__ = 'proto.ga4gh.variants_pb2'

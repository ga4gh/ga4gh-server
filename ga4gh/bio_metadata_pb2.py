...
_INDIVIDUAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='description', full_name='ga4gh.Individual.description', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='created', full_name='ga4gh.Individual.created', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='updated', full_name='ga4gh.Individual.updated', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='species', full_name='ga4gh.Individual.species', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sex', full_name='ga4gh.Individual.sex', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.Individual.info', index=7,
...
_BIOSAMPLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='description', full_name='ga4gh.BioSample.description', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='created', full_name='ga4gh.BioSample.created', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='updated', full_name='ga4gh.BioSample.updated', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='individual_id', full_name='ga4gh.BioSample.individual_id', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.BioSample.info', index=7,
      number=8, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INDIVIDUAL_INFOENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
_BIOSAMPLE_INFOENTRY.has_options = True
_BIOSAMPLE_INFOENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')

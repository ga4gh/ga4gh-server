...
_READALIGNMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='proper_placement', full_name='ga4gh.ReadAlignment.proper_placement', index=3,
...
_READGROUP.fields_by_name['experiment'].message_type = ga4gh_dot_metadata__pb2._EXPERIMENT
